...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/_sitemap` | `/bag` | `/catalogue/pants` | `/catalogue/shirts` | `/catalogue/skirts` | `/catalogue/sweaters` | `/checkout` | `/closet` | `/login` | `/purchase` | `/purchase/confirmed` | `/purchase/data` | `/space`;
  type DynamicRoutes<T extends string> = `/catalogue/pants/${SingleRoutePart<T>}` | `/catalogue/shirts/${SingleRoutePart<T>}` | `/catalogue/skirts/${SingleRoutePart<T>}` | `/catalogue/sweaters/${SingleRoutePart<T>}` | `/locker/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/catalogue/pants/[id]` | `/catalogue/shirts/[id]` | `/catalogue/skirts/[id]` | `/catalogue/sweaters/[id]` | `/locker/[id]`;
